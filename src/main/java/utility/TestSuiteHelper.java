...
public class TestSuiteHelper {
    ...
    public static void takeScreenShotHelper() {
        try {
            ...
            S3UploadHelper.uploadReportToS3Bucket(Constant.S3UploadFileConstats.SCREENSHOTFILEOBJECTKEYNAME + filePaths[2],
                    filePaths[0], Constant.S3UploadFileConstats.PNGCONTENTYPE);
    ...
    public static String getCharFromText(String text, int beginIndex, int endIndex) {
